...
<body>
<?php include $_SERVER['DOCUMENT_ROOT'] . '/BTTH02/views/includes/navbar.php'; ?>

    <?PHP require_once $_SERVER['DOCUMENT_ROOT'] . '/BTTH02/models/News.php';?>
    ...
    <?php include $_SERVER['DOCUMENT_ROOT'] . '/BTTH02/views/includes/footer.php'; ?>
